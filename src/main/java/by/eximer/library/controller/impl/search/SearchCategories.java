...
public class SearchCategories implements Command {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		final Logger log = LoggerFactory.getLogger(SearchCategories.class); //final Logger log = LogManager.getLogger(BasketAll.class.getName());
		...
		try {
			...
			user = userService.searchCategories(searchString, tip, max, min, sort_price);
