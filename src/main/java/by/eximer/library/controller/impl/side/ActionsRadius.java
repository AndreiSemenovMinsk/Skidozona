...
public class ActionsRadius implements Command {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		final Logger log = LoggerFactory.getLogger(ActionsRadius.class); //final Logger log = LogManager.getLogger(InBasket.class.getName());
